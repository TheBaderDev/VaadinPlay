...
public abstract class _User extends BaseDataObject {
    ...
    public static final Property<String> ITEM_FLAGS = Property.create("itemFlags", String.class);
    ...
    public void setItemFlags(String itemFlags) {
        beforePropertyWrite("itemFlags", this.itemFlags, itemFlags);
        this.itemFlags = itemFlags;
    }

    public String getItemFlags() {
        beforePropertyRead("itemFlags");
    ...
    protected void writeState(ObjectOutputStream out) throws IOException {
        ...
        out.writeObject(this.itemFlags);
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.itemFlags = (String)in.readObject();
